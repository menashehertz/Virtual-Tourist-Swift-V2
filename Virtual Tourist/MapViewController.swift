...
class MapViewController: UIViewController {
    ...
    @IBAction func addPin(sender: UILongPressGestureRecognizer) {
        ...
        if sender.state == .Ended {
            ...
            print("about to add pin at latitude \(locCoord.latitude) longitude \(locCoord.longitude)")
...
extension Double {
    ...
    extension MapViewController : MKMapViewDelegate {
        ...
        func mapView(mapView: MKMapView, didSelectAnnotationView view: MKAnnotationView) {
            ...
            print("pin clicked \(view.annotation!.coordinate.latitude)")
            ...
            print("the selected ---- the latitude is  \(Flickr.oneSession.latitude) the longitude is  \(Flickr.oneSession.longitude) ")
            ...
            for thePin in pins {
                ...
                print(" the latitude is  \((thePin.latitude as Double).roundTo5) the longitude is  \((thePin.longitude as Double).roundTo5) ")
            }
