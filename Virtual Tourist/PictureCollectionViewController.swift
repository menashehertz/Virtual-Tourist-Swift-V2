...
class PictureCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate,
    ...
    override func viewDidLoad() {
        ...
        print("this is from pin \(pinMK.annotation!.coordinate.latitude)")
        print("this is from currnt pin number of photos \(pin.photos.count)")
        print("this is from current pin latitude \(pin.latitude)")
...
//        }
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        print("did select this number \(indexPath.row)")
    ...
    func configureCell(cell: UICollectionViewCell, photo: Photo) {
        print("Actual file name \(photo.actualFileName)")
        ...
        if photo.photoImage != nil {
            ...
            print("The movie has an image name, but it is not downloaded yet")
